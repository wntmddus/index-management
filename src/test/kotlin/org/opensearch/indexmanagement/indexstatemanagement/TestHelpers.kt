...
fun randomRestoreActionConfig(repository: String = "repo", snapshot: String = "sp"): ConvertIndexToRemoteAction = ConvertIndexToRemoteAction(repository, snapshot, includeAliases = false, ignoreIndexSettings = "", numberOfReplicas = 0, deleteOriginalIndex = false, index = 0)
